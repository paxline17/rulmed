    ...
    <div class="row justify-content-center g-4">
        <div class="col-10 col-md-6">
            <div class="card forsideCard h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title d-flex justify-content-between align-items-center mb-0">Indsamling
        ...
        <div class="col-10 col-md-6">
            <div class="card forsideCard h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title d-flex justify-content-between align-items-center mb-0">Livet i kørestol
                        <button type="button" class="btn btn-lg">
        ...
        <div class="col-10 col-md-6">
            <div class="card forsideCard h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title d-flex justify-content-between align-items-center mb-0">Sponsor
                        <button type="button" class="btn btn-lg">
        ...
        <div class="col-10 col-md-6">
            <div class="card forsideCard h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title d-flex justify-content-between align-items-center mb-0">Danmark for alle
                        <button type="button" class="btn btn-lg">
